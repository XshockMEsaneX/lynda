<?php
/**
 * lynda functions and definitions.
 *
...
if ( ! function_exists( 'lynda_setup' ) ) :
/**
...
function lynda_setup() {
	 ...
	 * If you're building a theme based on lynda, use a find and replace
	 * to change 'lynda' to the name of your theme in all the template files
	 */
	load_theme_textdomain( 'lynda', get_template_directory() . '/languages' );
 ...
 */
function lynda_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'lynda_content_width', 640 );
}
add_action( 'after_setup_theme', 'lynda_content_width', 0 );
 ...
 */
function lynda_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'lynda' ),
		'id'            => 'sidebar-1',
		'description'   => '',
...
add_action( 'wp_enqueue_scripts', 'lynda_scripts' );
